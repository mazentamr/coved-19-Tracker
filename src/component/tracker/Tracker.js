    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.tracer_list}>
                <Statistics Icon={icon5} dis={"Recovered"} num={tracker.recovered} color={"#557d20"} />
                <Statistics Icon={icon6} dis={"Deaths"} num={tracker.deaths} color={"#af1a1b"} />
                <Statistics Icon={icon7} dis={"Confirmed Cases"} num={tracker.active} color={"#ba9500"} />
                <Statistics Icon={icon8} dis={"Total Country"} num={tracker.cases} color={"#130947"} />
            </div>
        </div>
    )
}
